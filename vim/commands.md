...
|r&lt;s&gt;|カーソルの文字を`s`に置換|
|c|現在のカーソル、もしくは選択した範囲を削除してインサートモード|
|0|行頭に移動|
|^|行頭に移動|
|$|行末に移動|
|w|次の単語に移動|
...
|q/|コマンド履歴の検索|
|ctrl-v|矩形ビジュアルモード|
|shift-I|矩形ビジュアルモードで先頭からインサートモード|
|shift-A|矩形ビジュアルモードで末尾にインサートモード|
|:E|ファイルエクスプローラーを開く|
|D|エクスプローラーでファイルを削除する。|
|-|エクスプローラーで親ディレクトリに移動する。|
|d|エクスプローラーでディクレトリを作成|
|R|エクスプローラーで名前を変更|
|%|エクスプローラーで新規ファイルを作成|
|t|エクスプローラーで新規タブで開く|
|u|エクスプローラーで戻る|
|i|エクスプローラーで表示切り替え|
|ls|ファイルのバッファの一覧(サポートされていないプラグインあり)|
|b <n>|指定したバッファのファイルに移動(サポートされていないプラグインあり)|
